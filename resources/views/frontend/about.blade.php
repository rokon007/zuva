...
.centered {
  ...
  <div class="my-3 p-3 bg-body rounded shadow-sm">
    ...
    <div class="d-flex text-muted pt-3">
     <div class="fa-3x">
  <i class="fa-solid fa-basketball fa-bounce" width="32" height="32" ></i>
</div>&nbsp;&nbsp;&nbsp;
    ...
    <div class="d-flex text-muted pt-3">
     <div class="fa-3x">
      ...
      <p class="pb-3 mb-0 small lh-sm border-bottom">
       <strong class="d-block text-warning">Making each individual the best version of themselves they can be.</strong>
  ...
  <i class="fa-solid fa-basketball fa-bounce"></i>
      ...
      <p class="pb-3 mb-0 small lh-sm border-bottom">
        <strong class="d-block text-warning"> Confidence for life beyond education</strong>

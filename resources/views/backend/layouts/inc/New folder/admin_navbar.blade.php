<div class="navbar">
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <a class="brand" href="index.html"><span>Jim Electric</span></a>
            ...
            <div class="nav-no-collapse header-nav">
                <ul class="nav pull-right">
					...
					<li>
                        <a class="btn" href="{{ url('admin/all_products')}}">
                           <!-- <i class="halflings-icon white wrench"></i>-->
							<i class="halflings-icon white tasks"></i>Shop
                        </a>
                    </li>
                    <li>
                        <a class="btn" href="{{ route('cart.list') }}">
                           <!-- <i class="halflings-icon white wrench"></i>-->

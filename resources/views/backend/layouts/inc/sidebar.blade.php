 <aside class="sidebar-wrapper" data-simplebar="true">
          <div class="sidebar-header">
            ...
            <div>
              <h4 style=" color: #008000;">Zuva Academy</h4>
            </div>
          ...
          <ul class="metismenu" id="menu">
            <li>
              <a href="{{ route('dassboard') }}" class="has-arrow">
            ...
            <li>
              ...
              <ul>
                ...
                <li> <a href="app-file-manager.html"><i class="bi bi-arrow-right-short"></i>Staff Page</a>
                </li>
                <li> <a href="app-to-do.html"><i class="bi bi-arrow-right-short"></i>Contact Page</a>
                </li>
                <li> <a href="app-invoice.html"><i class="bi bi-arrow-right-short"></i>Curriculum Page</a>
                </li>
                <li> <a href="app-fullcalender.html"><i class="bi bi-arrow-right-short"></i>Home Page</a>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul>
                <li> <a href="#"><i class="bi bi-arrow-right-short"></i>Categories</a>
                </li>
                <li> <a href="widgets-data-widgets.html"><i class="bi bi-arrow-right-short"></i>Add Category</a>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul>
                ...
                <li> <a href="#"><i class="bi bi-arrow-right-short"></i>Add New Product</a>
                </li>
